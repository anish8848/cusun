	...
	<header class="main-header header-style-three">
			...
			<div class="header-bottom">
					<div class="container-fluid">
							<div class="nav-outer">
									<div class="logo-box">
											<figure class="logo-outer"><a href="{{route('home')}}"><img src="images/logo-3.png" alt=""></a></figure>
									</div>
									<div class="menu-area">
															...
															<ul class="navigation clearfix">
																	...
																	<li class="dropdown"><a href="#">About us</a>
																			<ul>
																					...
																					<li><a href="{{route('goal')}}">Goals Objectives &Strategy</a></li>
																					<li><a href="{{route('other')}}">Others</a></li>
					...
					<div class="container">
							<div class="row">
									<div class="col-lg-4 col-md-12 col-sm-12 column">
											<figure class="logo-box"><a href="{{route('home')}}"><img src="images/small-logo.png" alt=""></a></figure>
									</div>
